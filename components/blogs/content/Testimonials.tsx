                ...
                <div className="relative mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16 lg:py-20 text-default">
                    ...
                    <div className="flex items-stretch justify-center">
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                            <div className="card max-w-sm h-full hover:border-blue-600 hover:shadow-lg hover:transition hover:duration-100 bg-white
                            p-4
                            ">
                                    ...
                                    <div className="flex flex-col justify-between items-stretch w-full h-full">
                                        ...
                                        <blockquote className="flex-auto">
                                            <p className="font-light dark:text-slate-400">
                                                " ScribbleSphere has transformed my blogging journey!
                                                The seamless interface and powerful features made
                                                publishing and sharing my thoughts a breeze. It ... "
                                            </p>
                                        </blockquote>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex flex-col justify-between items-stretch w-full h-full">
                                        ...
                                        <blockquote className="flex-auto">
                                            <p className="font-light dark:text-slate-400">
                                                ...
                                                TailNext not only meets but exceeds these
                                                expectatio... "
                                            </p>
                                        </blockquote>
                                    </div>
                                    ...
                                    <div className="flex flex-col justify-between items-stretch w-full h-full">
                                        ...
                                        <blockquote className="flex-auto">
                                            <p className="font-light dark:text-slate-400">
                                                ...
                                                Scribblesphere provides an unbeatable foundation for
                                                my blog. The attention to detail in design, combined
                                                w... "
                                            </p>
                                        </blockquote>
                                    </div>
                            ...
                            <div className="card max-w-sm h-full hover:border-blue-600 hover:shadow-lg hover:transition hover:duration-100 p-4 bg-white">
                                ...
                                <div className="select-none h-full">
                                    <div className="flex flex-col justify-between items-stretch w-full h-full">
                                        ...
                                        <blockquote className="flex-auto">
                                            <p className="font-light dark:text-slate-400">
                                                " Starting a blog can be daunting, but Scribblesphere
                                                made it surprisingly simple. The thoughtful guidance
                                                and responsive support team ensured a smooth ... "
                                            </p>
                                        </blockquote>
                                    </div>
                                </div>
                            ...
                            <div className="card max-w-sm h-full hover:border-blue-600 hover:shadow-lg hover:transition hover:duration-100 p-4 bg-white">
                                ...
                                <div className="select-none h-full">
                                    <div className="flex flex-col justify-between items-stretch w-full h-full">
                                        ...
                                        <blockquote className="flex-auto">
                                            <p className="font-light dark:text-slate-400">
                                                " Scribblesphere offers a perfect blend of creativity
                                                and functionality. The templates are stunning, and the
                                                platform is designed to cater to bloggers o... "
                                            </p>
                                        </blockquote>
                                    </div>
                                </div>
